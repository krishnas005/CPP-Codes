...
struct segmentTree {
    ...
    // can be used when we are asked to remove the kth element from the array after the operation, hence we will be marking 0 to removed elements and then we can find the kth element in the array by adding, using this function though segment tree
